...
>     if (nd) {
>         console.log("label 查找 设置 节点信息 {}  ", JSON.stringify(nd))
>         // 如果找到了 就点击
>         let c = clickPoint(nd.bounds.centerX(), nd.bounds.centerY());
>         logd("点他: {}", c)
>     } else {
>         console.log("label 未查找 设置 节点信息  ")
>     }
>     // 按照 正则表达式匹配
>     nd = labelMatch(".*置.*").getNodeInfo(1000)
>     if (nd) {
>         console.log("labelMatch 查找 设置 节点信息 {}  ", JSON.stringify(nd))
>     } else {
>         console.log("labelMatch 未查找 设置 节点信息  ")
>     }
>     // 先释放老的数据
>     releaseNode();
> }
...
>     if (nd) {
>         console.log("name 查找 设置 节点信息 {}  ", JSON.stringify(nd))
>         // 如果找到了 就点击
>         let c = clickPoint(nd.bounds.centerX(), nd.bounds.centerY());
>         logd("点他: {}", c)
>     } else {
>         console.log("name 未查找 设置 节点信息  ")
>     }
>     // 按照 name 正则表达式匹配
>     nd = nameMatch(".*置.*").getNodeInfo(1000)
>     if (nd) {
>         console.log("nameMatch 查找 设置 节点信息 {}  ", JSON.stringify(nd))
>     } else {
>         console.log("nameMatch 未查找 设置 节点信息  ")
>     }
>     // 先释放老的数据
>     releaseNode();
> }
...
>     // 进入查找状态
>     // 按照 type 查找
>     let nd = type("设置").getOneNodeInfo(1000)
>     if (nd) {
>         console.log("type 查找 设置 节点信息 {}  ", JSON.stringify(nd))
>         // 如果找到了 就点击
>         let c = clickPoint(nd.bounds.centerX(), nd.bounds.centerY());
>         logd("点他: {}", c)
>     } else {
...
>     }
>     // 按照 type 正则表达式匹配
>     nd = typeMatch(".*置.*").getNodeInfo(1000)
>     if (nd) {
>         console.log("typeMatch 查找 设置 节点信息 {}  ", JSON.stringify(nd))
>     } else {
>         console.log("ltypeMatch 未查找 设置 节点信息  ")
>     }
>     // 先释放老的数据
>     releaseNode();
> }
